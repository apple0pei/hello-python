...
#%%
#import pandas as pd
pd4 = pd.read_csv("/Users/applepei/Documents/Work/Kaggle/Plankton2015/sampleSubmission.csv",header=0)

print pd4.columns[1:100]
print y_train
y_train_label = []
for i in range(0,len(files)):
    y_train_label.append(files[i].split('/')[8])

column_head = pd4.columns[1:]
...
def bench_k_means(estimator, name, data):
    ...
    print('% 9s   %.2fs    %i   %.3f   %.3f   %.3f   %.3f   %.3f    %.3f'
          % (name, (time() - t0), estimator.inertia_,
             metrics.homogeneity_score(y_train_label, estimator.labels_),
             metrics.completeness_score(y_train_label, estimator.labels_),
             metrics.v_measure_score(y_train_label, estimator.labels_),
             metrics.adjusted_rand_score(y_train_label, estimator.labels_),
             metrics.adjusted_mutual_info_score(y_train_label,  estimator.labels_),
...
kmeans = KMeans(init='k-means++', n_clusters=n_class, n_init=30)
kmeans.fit(X_train,align_y_train)
#%%

#%%
y_pred_v = kmeans.predict(X_train)
y_pred = kmeans.predict(X)
#%%

#%%
print align_y_train[12910:12955],y_train_label[12910:12955],y_pred[12910:12955]
print pd4.columns[116]
#%%
num_rows = len(y_pred)
jpg_name=[]
...
pd4.loc[0:num_rows-1]=test_perf[:]
...
#%%
pd4.to_csv("/Users/applepei/Documents/Work/Kaggle/Plankton2015/pd4Submission.csv", index = False)
#%%
